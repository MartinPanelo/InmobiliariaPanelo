...
--
-- Servidor: localhost
-- Tiempo de generación: 29-08-2023 a las 07:20:07
...
--
ALTER TABLE `usosInmuebles`
  MODIFY `IdUsoInmueble` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `inmuebles`
  ...
  ADD CONSTRAINT `inmuebles_ibfk_2` FOREIGN KEY (`Tipo`) REFERENCES `tiposInmuebles` (`IDTipoInmueble`) ON UPDATE CASCADE,
